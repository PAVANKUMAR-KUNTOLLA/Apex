...
from apex.settings import DEFAULT_FROM_EMAIL
    ...
    try:
        if request.method == "POST":
            ...
            if user_data["role"] == "CLIENT":
                subject = 'User Signed Up - Apex Tax Filers'
                login_url = request.build_absolute_uri(f'/login')
                message = f'"This is an Automated Mail" \n\nHi {user_data["email"]}, \nYou have successfully signed-up for a user account, for the Apex Tax Filers. You can login now.\n\nregards,\nApex Tax Filers Digitisation Team. \n\n you can login through the below link - {login_url}'
